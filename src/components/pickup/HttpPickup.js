...
const HttpPickup = () => {
  ...
  const onFinish = (values) => {
    ...
    sendData(`${process.env.REACT_APP_API_BASE_URL}/api/pickup`,connectionHTTP);
  ...
  async function sendData(url,data){
    ...
    try{
     ...
     setLoading(false);
     message.info(`A HTTP pickup was created with ID ${responseData.id}.`);
    }catch(error){
